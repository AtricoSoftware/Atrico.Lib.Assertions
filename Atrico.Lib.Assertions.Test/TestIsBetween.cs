...
namespace Atrico.Lib.Assertions.Test
{
    ...
    public class TestIsBetween
    {
        ...
        public void TestIsBetweenPassMin()
        {
            ...
            // Act
            var ex = Catch.Exception(() => Assert.That(Value.Of(actual).Is().Between(lowerLimit, upperLimit)));
        ...
        public void TestIsNotBetweenFailMin()
        {
            ...
            // Act
            var ex = Catch.Exception(() => Assert.That(Value.Of(actual).Is().Not().Between(lowerLimit, upperLimit)));
