...
namespace Atrico.Lib.Assertions.Test
{
	...
	public class TestIsEqualTo
	{
		...
		public void TestEqualToPass()
		{
			...
			// Act
			var ex = Catch.Exception(() => Assert.That(actual, Is.EqualTo(expected)));
		...
		public void TestEqualToMessagePlus()
		{
			...
			// Act
			var ex = Catch.Exception(() => Assert.That(actual, Is.EqualTo(expected), message));
		...
		public void TestNotEqualToPass()
		{
			...
			// Act
			var ex = Catch.Exception(() => Assert.That(actual, Is.Not.EqualTo(expected)));
