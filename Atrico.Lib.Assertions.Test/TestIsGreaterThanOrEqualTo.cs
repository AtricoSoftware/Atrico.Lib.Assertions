...
namespace Atrico.Lib.Assertions.Test
{
	...
	public class TestIsGreaterThanOrEqualTo
	{
		...
		public void TestIsGreaterThanOrEqualToPassMore()
		{
			...
			// Act
			var ex = Catch.Exception(() => Assert.That(actual, Is.GreaterThanOrEqualTo(expected)));
		...
		public void TestIsNotGreaterThanOrEqualToFailMore()
		{
			...
			// Act
			var ex = Catch.Exception(() => Assert.That(actual, Is.Not.GreaterThanOrEqualTo(expected)));
