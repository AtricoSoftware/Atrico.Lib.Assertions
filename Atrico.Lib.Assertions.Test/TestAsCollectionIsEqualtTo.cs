...
namespace Atrico.Lib.Assertions.Test
{
    ...
    public class TestAsCollectionIsEqualtTo
    {
        ...
        public void TestAsCollectionIsEqualToMessageMissingItem()
        {
            ...
            // Assert
            var expectedMsg = string.Format("AsCollection.Is.EqualTo failed. Expected:<[1,2,3,4]>, Actual:<[1,2,4]>: Count<-1>, Missing<[3]>");
        ...
        public void TestAsCollectionIsEqualToMessageExtraItem()
        {
            ...
            // Assert
            var expectedMsg = string.Format("AsCollection.Is.EqualTo failed. Expected:<[1,2,4]>, Actual:<[1,2,3,4]>: Count<+1>, Extra<[3]>");
            Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual(expectedMsg, ex.Message);
            Debug.WriteLine(ex.Message);
        }
        ...
        public void TestAsCollectionIsEqualToMessageExtraDuplicateItem()
        {
            ...
            // Assert
            var expectedMsg = string.Format("AsCollection.Is.EqualTo failed. Expected:<[1,2,3]>, Actual:<[1,2,3,3]>: Count<+1>, Extra<[3]>");
            Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual(expectedMsg, ex.Message);
            Debug.WriteLine(ex.Message);
        }
